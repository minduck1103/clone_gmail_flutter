...
class _InboxScreenState extends State<InboxScreen> {
  ...
  Widget _buildDrawerItem(IconData icon, String title, int count) {
    return ListTile(
      leading: Icon(icon),
      title: Text(title),
      trailing:
      ...
      onTap: () {
        ...
        switch (title) {
          case 'Primary':
            // Already on Primary screen (InboxScreen)
            break;
          case 'Promotions':
          ...
          case 'Important':
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => const ImportantScreen()),
            );
            break;
          case 'Sent':
            Navigator.pushReplacement(
